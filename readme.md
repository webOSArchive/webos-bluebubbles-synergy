# webos-bluebubbles-synergy

webOS Synergy synchronization connector for [BlueBubbles](https://bluebubbles.app) to sync iMessages into the native webOS Messages app. Forked from the original [Message Bridge](https://github.com/dremin/message-bridge) connector and re-targeted at the BlueBubbles REST API.

Please read [notes.md](notes.md) for more documentation on how this was built.
